            ...
            highlight_overrides = {
                all = function(colors)
                    return {
                        ...
                        NeoTreeTabInactive = { fg = colors.surface2, bg = "NONE" },
                        NeoTreeTabSeparatorActive = { fg = colors.mantle, bg = "NONE" },
                        NeoTreeTabSeparatorInactive = { fg = colors.crust, bg = "NONE" },
                        NeoTreeWinSeparator = { fg = colors.base, bg = "NONE" },
